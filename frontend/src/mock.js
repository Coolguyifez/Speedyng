...
export const categories = [
  ...
  { name: 'Box Truck', icon: 'Truck' },
  { name: 'Dump Truck', icon: 'Truck' },
  { name: 'Flatbed Truck', icon: 'Truck' },
  { name: 'Tanker Truck', icon: 'Truck' },
  { name: 'Refrigerator Truck', icon: 'Truck' },
  { name: 'Tow Truck', icon: 'Truck' },
  { name: 'Trailer Head', icon: 'Truck' },
  { name: 'Single Cabin Pickup', icon: 'FaTruckPickup' },
  { name: 'Double Cabin Pickup', icon: 'FaTruckPickup' },
  { name: 'Compact Pickup', icon: 'FaTruckPickup' },
  { name: 'Full-Size Pickup', icon: 'FaTruckPickup' },
  { name: 'Heavy-Duty Pickup (Dually)', icon: 'FaTruckPickup' },
  { name: 'Off-Road Pickup', icon: 'FaTruckPickup' },
  { name: 'Mini-Bus', icon: 'Bus' },
  { name: 'Coaster Bus', icon: 'Bus' },
  { name: 'School Bus', icon: 'Bus' },
  { name: 'Luxury Coach', icon: 'Crown' },
  { name: 'Cargo Van', icon: 'PiVan' },
  { name: 'Passenger Van', icon: 'PiVan' },
  { name: 'Minivan', icon: 'PiVan' },
  { name: 'Panel Van', icon: 'PiVan' },
  { name: 'Sport Bike', icon: 'FaMotorcycle' },
  { name: 'Cruiser', icon: 'Crown' },
  { name: 'Touring Bike', icon: 'FaMotorcycle' },
  { name: 'Standard Motorcycle', icon: 'FaMotorcycle' },
  { name: 'Passenger Keke', icon: 'PiMotorcycleLight' },
  { name: 'Cargo Tricycle', icon: 'PiMotorcycleLight' },
  { name: 'Delivery Tricycle', icon: 'PiMotorcycleLight' },
];
